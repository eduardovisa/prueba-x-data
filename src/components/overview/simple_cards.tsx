import { SimpleCardsProps } from '@/types/components/overview';
import React from 'react';

const SimpleCards: React.FC<{ data: SimpleCardsProps[] }> = (data) => {
  ...
  data.data.map((cardInfo, index) => {
    card_list.push(
      <div
        ...
        className="flex item-center justify-center w-[194px] h-134 sm:w-[298px] lg:w-[258px] cursor-pointer flex flex-col items-center border rounded-[8px] bg-white border-primary-gray-light hover:border-primary-blue hover:border-2 group"
      >
